...
<head>
    ...
    @else
        <title>Фирменный магазин АкваТехника - продажа водяных насосов с доставкой по всей России. Погружные и поверхностыне насосы, станции водоснабжения икомплектующие.</title>
        <meta name="description" content="Интернет-магазин AquaTechnica. Каталог насосного оборудования. Продажа электронасосов. Как купить насос. Советы по выбору.">
        <meta name="keywords" content="Электронасосы, купить погружной насос, продажа, дренажный насос, водяной насос, запчасти к насосам, поверхностный насос, станция водоснабжения, насосы Поток, насосы Акватехника, насосы Aquatechnica">
    @endif
